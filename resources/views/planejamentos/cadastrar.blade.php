    ...
    <div class="w-100 py-16">        
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="container justify-content-center">
                ...
                <form method="POST" action="/planejamentos/cadastrar">
                    <input type="hidden" name="hora_saida" value="{{$parametros['hora_saida']}}">
                    @csrf
                    <div class="container">
                        <table class="table table-bordered">
                            ...
                            <tbody class="text-start">
                                <tr>
                                    ...
                                    <td><input class="text-end w-100 bg-transparent border-0"  id="rend_tip_ciclotron" type="number" name="rend_tip_ciclotron" value="{{old('rend_tip_ciclotron', $parametros['rend_tip_ciclotron'])}}" required></td> 

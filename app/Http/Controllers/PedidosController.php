...
class PedidosController extends Controller
{
    ...
    public function update(Request $request){
        if (count(Pedido_Plan::where('id_pedido', $request->id)->get()) > 0)
        ...
        $validator = Validator::make(
            ...
            ['id_cliente' => Rule::unique('pedidos')->where('id_cliente', $id_cliente)->where('data_entrega', $request->data_entrega)->ignore($request->id)],
        ...
        Pedido::findOrFail($request->id)->update([
            'id_cliente' => $id_cliente,
